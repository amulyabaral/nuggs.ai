    ...
    <div className="pageContainer">
        ...
        <nav>
          ...
          {user ? (
            ...
            <Link href="/#login" className="navLink authNavButton" scroll={false} onClick={(e) => {
              ...
              // For now, direct to home and expect modal to be triggerable from there.
              // Or, if you have a global modal state, trigger it here.
              e.preventDefault();
              // Example: router.push('/?auth=login'); or trigger global modal state
      ...
      <main className="contentContainer" style={{ maxWidth: '800px', margin: '2rem auto', padding: '0 1.5rem' }}>
        ...
        <section>
          ...
          <p>
            Any new features or services which are added to the current site shall also be subject to the Terms of Service. You can review the most current version
        ...
        <section>
          ...
          <p>
            ...
            subject to return or exchange only according to our Return Policy. To view our Return Policy, please visit <a href="/return-policy" target="_blank" rel="noopener noreferrer">our Return Policy</a>.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            Payments are processed through our third-party payment provider, Paddle. By making a purchase, you also agree to comply with Paddle's terms of service.
            You agree to promptly update your account and other information, including your email address and credit card numbers and expiration dates, so that we can complete
            your transactions and contact you as needed.
          </p>
          <p>
            For more detail, please review our <a href="/return-policy" target="_blank" rel="noopener noreferrer">Returns Policy</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy, please see <a href="/privacy-policy" target="_blank" rel="noopener noreferrer">our Privacy Policy</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            In no case shall nuggs.ai, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable
        ...
        <section>
          ...
          <p>
            You agree to indemnify, defend and hold harmless nuggs.ai and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors,
